...
<div class="mail-scroll">
        ...
        <a href="{{ $showUrl }}" class="mail-item {{ $isUnread ? 'unread' : 'read' }}">
            ...
            <div class="mail-content d-flex align-items-center justify-content-between">
                <div class="mail-sender" style="flex: 0 0 200px;">
                    <span class="badge bg-purple text-white me-2" style="background-color: #8b5cf6;">Tugas Saya</span>
                    {{ $disp->fromUser->name ?? 'Unknown' }}
                </div>
                ...
                <div class="d-flex align-items-center px-3" style="flex: 1; min-width: 0;">
                    ...
                    <div class="mail-snippet">
                        {!! Str::limit(strip_tags($disp->note ?? $letter->body), 80) !!}
                    </div>
                </div>
    ...
    @empty
        <div class="text-center py-5">
            ...
            <p class="text-muted" style="font-size: 0.9rem;">Anda belum menerima tugas disposisi baru.</p>
        </div>
    @endforelse
</div>
@endsection