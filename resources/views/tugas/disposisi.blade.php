...
<div class="mail-scroll">
        ...
        <a href="{{ $showUrl }}" class="mail-item {{ $isUnread ? 'unread' : 'read' }}">
            ...
            <div class="mail-content d-flex align-items-center justify-content-between">
                <div class="mail-sender" style="flex: 0 0 200px;">
                    <span class="badge bg-info text-dark me-2">Disposisi</span>
    ...
    @empty
        <div class="text-center py-5">
            <i class="bi bi-journal-check text-muted" style="font-size: 4rem;"></i>
            <h5 class="mt-3 text-muted">Tidak ada tugas disposisi</h5>
            <p class="text-muted" style="font-size: 0.9rem;">Anda tidak memiliki surat yang perlu didisposisikan.</p>
        </div>
    @endforelse
</div>
@endsection