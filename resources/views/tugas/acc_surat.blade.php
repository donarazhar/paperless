...
<div class="mail-scroll">
    @forelse($letters as $letter)
        @php
            $isUnread = in_array($letter->status, ['pending_approval', 'in_review_subag', 'in_review_bagian_tu']);
        ...
        <a href="{{ $showUrl }}" class="mail-item {{ $isUnread ? 'unread' : 'read' }}">
            ...
            <div class="mail-content d-flex align-items-center justify-content-between">
                <div class="mail-sender" style="flex: 0 0 200px;">
                    <span class="badge bg-warning text-dark me-2">Perlu ACC</span>
    ...
    @empty
        <div class="text-center py-5">
            ...
            <h5 class="mt-3 text-muted">Tidak ada tugas persetujuan</h5>
            <p class="text-muted" style="font-size: 0.9rem;">Anda tidak memiliki surat yang menunggu untuk di-ACC.</p>
        </div>
    @endforelse
</div>
@endsection