    ...
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-3" style="position:relative;z-index:1;">
        <div>
            <div class="d-flex align-items-center gap-2 mb-1">
                ...
                <div class="hero-title">Arsip Surat</div>
            </div>
            <div class="hero-sub">Daftar surat yang sudah selesai atau menunggu diarsipkan</div>
        </div>
                ...
                <tr>
                    <td colspan="5">
                        <div class="empty-state">
                            ...
                            <div class="e-title">Tidak ada arsip</div>
                            <div class="e-sub">Belum ada surat yang masuk ke halaman arsip.</div>
                        </div>
                    </td>
                </tr>
            @endforelse
        ...
        <a href="{{ route('letters.show', ['letter' => \Vinkla\Hashids\Facades\Hashids::encode($letter->id)]) }}"
           class="letter-card {{ $disp ? 'has-disp' : '' }}">
            ...
            <div class="d-flex align-items-center justify-content-between">
                <span class="status-pill sp-done"><i class="bi bi-check-circle-fill"></i> Selesai</span>
