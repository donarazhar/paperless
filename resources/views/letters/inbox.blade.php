...
<div class="mail-scroll">
    @forelse($letters as $letter)
        @php
            // Simple logic to determine if it's read/unread based on dispositions or status
            // For now, let's assume it's unread if status is pending_agenda or something
    ...
    @empty
        <div class="text-center py-5">
            ...
            <h5 class="mt-3 text-muted">Kotak masuk Anda kosong</h5>
            <p class="text-muted" style="font-size: 0.9rem;">Belum ada surat masuk untuk saat ini.</p>
        </div>
    @endforelse
</div>
@endsection