...
<style>
    ...
    .recip-cell .r-name    { font-weight:600;color:#0f172a;font-size:0.85rem; }
    ...
    .btn-new  { display:inline-flex;align-items:center;gap:6px;background:linear-gradient(135deg,#16a34a,#2563eb);color:#fff;border:none;border-radius:0.65rem;font-size:0.85rem;font-weight:700;padding:0.55rem 1.1rem;text-decoration:none;transition:opacity .15s,transform .12s; }
...
<div class="d-flex align-items-center justify-content-between mb-3 flex-wrap gap-2">
    <div>
        <h1 class="h5 fw-bold mb-0" style="letter-spacing:-0.03em;">Surat Keluar Internal</h1>
        <p class="text-muted mb-0" style="font-size:0.82rem;">Daftar surat yang telah dikirim ke unit lain</p>
    </div>
    <div class="d-flex align-items-center gap-2">
        <span class="badge" style="background:#f0fdf4;color:#166534;font-size:0.78rem;padding:0.45rem 0.9rem;border-radius:100px;">
            <i class="bi bi-send-fill me-1"></i>{{ $letters->total() }} surat
        </span>
        @if(in_array(Auth::user()->role, ['staf_unit','staf_tu']))
            <a href="{{ route('letters.create') }}" class="btn-new">
                ...
                <tr>
                    ...
                    <td>
                        <div class="date-cell">
                            ...
                            <div class="d-time">{{ $letter->created_at->format('H:i') }} WIB</div>
                        </div>
                    </td>
                    <td>
