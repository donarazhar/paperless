...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // --- SEKRETARIAT YPI AL AZHAR (Unit ID: 1) ---
        $organAgenda = \App\Models\Organ::firstOrCreate(['name' => 'Admin Sekretariat', 'unit_id' => 1]);
        ...
        User::firstOrCreate(
            ...
            ['name' => 'Admin Keuangan', 'password' => Hash::make('123456'), 'role' => 'admin_unit', 'organ_id' => $organAdminKeu->id]
        );
        User::firstOrCreate(
            ['email' => 'kepalakeuangan@example.com'],
            ['name' => 'Kepala Keuangan', 'password' => Hash::make('123456'), 'role' => 'kepala_unit', 'organ_id' => $organKepalaKeu->id]
        );

        // --- BAGIAN ITTD (Unit ID: 3) ---
        $organAdminITTD = \App\Models\Organ::firstOrCreate(['name' => 'Admin ITTD', 'unit_id' => 3]);
        $organKepalaITTD = \App\Models\Organ::firstOrCreate(['name' => 'Kepala ITTD', 'unit_id' => 3]);
